...
var DEFAULT_ERROR_CLASSES = 'glyphicon glyphicon-exclamation-sign';
...
var BootstrapStaticWidget = Widget.extend({
  constructor: function BootstrapStaticWidget(kwargs) {
    ...
    this.convertStatic = kwargs && kwargs.convertStatic || (function(value)  {return value;});
    Widget.call(this, kwargs)
  },
  render:function(name, value, kwargs) {
    return (
        React.createElement("p", {className: "form-control-static"}, this.convertStatic(value))
    )
  }
})
...
var BootstrapForm = React.createClass({displayName: "BootstrapForm",
  ...
  propTypes: {
    ...
    errorClasses: React.PropTypes.string,
  ...
  renderRows:function() {
    ...
    var errorClasses = this.props.errorClasses
    ...
    if (formErrors.isPopulated()) {
      rows.push(React.createElement("div", {key: form.addPrefix('__all__'), className: "alert alert-danger has-error"}, 
        formErrors.messages().map(function(value)  {return errorMessage(value, errorClasses);})
      ))
    }
    rows.push.apply(rows, form.visibleFields().map(function(field) 
      {return React.createElement(BootstrapField, React.__spread({},  this.props, {key: field.htmlName, field: field}));}.bind(this)
    ))
...
var BootstrapField = React.createClass({displayName: "BootstrapField",
  ...
  render:function() {
    ...
    return (
      React.createElement("div", {className: this.getContainerClasses(field, status)}, 
  ...
  getContainerClasses:function(field, status) {
  ...
  isRadioSelect:function(field) {
    return field.field.widget instanceof RadioSelect;
  },

  isCheckboxSelectMultipleField:function(field) {
  ...
  getHelpText:function(field, status) {
  ...
  getError:function(field, status) {
    var errorClasses = this.props.errorClasses
    if (status == 'error') {
      return field.errors().messages().map(function(value)  {return errorMessage(value,errorClasses);});
    }
  },
  ...
  getHorizontalControlClasses:function(field) {
    var classes = [];
    var isBooleanField = this.isBooleanField(field);
    var h = this.props.horizontal;
...
var Container = React.createClass({displayName: "Container",
  ...
  render:function() {
    ...
    return React.createElement("div", {className: cx(this.props.className, {'container': !this.props.fluid, 'fluid': this.props.fluid})}, 
      ...
      React.Children.map(this.props.children, function(row, index)  {return React.cloneElement(row, Object.assign({},
      this.props
      , {index: index
      , className: null    
      }));}.bind(this)), 
  ...
  render:function() {
    ...
    return React.createElement("div", {className: cx('row', this.props.className)}, 
      React.Children.map(this.props.children, function(child, index)  {
        return React.cloneElement(child, extend(Object.assign({},
        this.props
        ,  {className: null    
        }), columnProps[index]))
      }.bind(this))
...
var Field = React.createClass({displayName: "Field",
  ...
  render:function() {
    ...
    return React.createElement("div", {className: this.getColClassName()}, 
      React.createElement(BootstrapField, React.__spread({},  this.props, {key: field.htmlName, field: field}))
    )
  }
})
